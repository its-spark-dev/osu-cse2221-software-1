...
public final class StringReassembly {
    ...
    public static String combination(String str1, String str2, int overlap) {
        ...
        /*
         * Remove the overlapping from str1 and append str2.
         */
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet, String str) {
        ...
        /*
         * If str is already a substring of any existing string in the set, do
         * not add it.
         */
        for (String existing : strSet) {
        ...
        /*
         * Create a temporary set to collect elements that are substrings of
         * str.
         */
        ...
        /*
         * Remove the collected elements from strSet.
         */
    ...
    public static Set<String> linesFromInput(SimpleReader input) {
        ...
        /*
         * Create a new set to store the lines.
         */
        Set<String> lines = new Set1L<>();

        /*
         * Read each line from input until end-of-stream, and add it to the set
         * using the addToSetAvoidingSubstrings method.
         */
        while (!input.atEOS()) {
    ...
    public static void printWithLineSeparators(String text, SimpleWriter out) {
        ...
        /*
         * Iterate over each character in the text. If the character is '~',
         * print a newline; otherwise, print the character.
         */
