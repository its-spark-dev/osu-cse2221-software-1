...
public final class IntegerRoot {
    ...
    private static int root(int n, int r) {
        ...
        /**
         * [MY FIRST TRY] double base = n; double power = r; double root =
         * Math.pow(base, 1 / power) int result = (int) root; return result;
         */
    ...
    public static void main(String[] args) {
        ...
        final int[] numbers = { 0, 0, 0, 1, 1, 1, 82, 82, 82, 82, 82, 3, 9, 27, 81, 243 };
        ...
        for (int i = 0; i < numbers.length; i++) {
            ...
            if (x == results[i]) {
                ...
                out.println("*** Test failed: root(" + numbers[i] + ", " + roots[i]
                        + ") expected <" + results[i] + "> but was <" + x + ">");
            }
        }
